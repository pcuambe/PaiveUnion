...
public class Evento implements Serializable {
    ...
    @JoinTable(name = "Ev_MatUso", joinColumns = @JoinColumn(name = "codigoEvento"),
            inverseJoinColumns = @JoinColumn(name = "codigoMaterial"))
    private Set<MaterialUso> materiais = new HashSet<>();
    ...
    public Set<MaterialUso> getMateriais() {
        return materiais;
    }

    public void setMateriais(Set<MaterialUso> materiais) {
    ...
    public boolean isTerimando() {
        return terimando;
    }

    public void setTerimando(boolean terimando) {
        this.terimando = terimando;
    }
    
    @Override
    public String toString() {
        return "CodigoEvento: " + codigoEvento + " Titulo: " + titulo + " NrPessoas: " + nrPessoas ;
    }
